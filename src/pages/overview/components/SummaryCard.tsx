...
export const SummaryCard: React.FC<SummaryCardProps> = ({ sbom }) => {
  return (
            ...
            <DescriptionListDescription>
              <List isPlain>
                <ListItem>
                  ...
                  {sbom.report.summary.dependencies.scanned}
                </ListItem>
                <ListItem>
                  Transitive dependencies:{" "}
                  {sbom.report.summary.dependencies.transitive}
                </ListItem>
              </List>
            </DescriptionListDescription>
          </DescriptionListGroup>
            ...
            <DescriptionListDescription>
              <List isPlain>
                <ListItem>
                  ...
                  {sbom.report.summary.vulnerabilities.total}
                </ListItem>
                <ListItem>
                  Direct dependencies:{" "}
                  {sbom.report.summary.vulnerabilities.direct}
                </ListItem>
              </List>
            </DescriptionListDescription>
          </DescriptionListGroup>
